...
from utils.get_weight import get_weight_L2, get_weight_Chi2

from loss.loss import weighted_cross_entropy
    ...
    for step in range(1, args.steps + 1):
        ...
        if step > 0 and step % args.save_interval == 0:
            ...
            if step >= args.start_update and step % args.update_weight == 0:
                if args.distance == 'Chi2':
                    weights = get_weight_Chi2(all_source_features, all_source_labels, all_target_features, all_target_pseudo_labels)
                else: #args.distance == 'L2'
                    weights = get_weight_L2(all_source_features, all_source_labels, all_target_features, all_target_pseudo_labels)
