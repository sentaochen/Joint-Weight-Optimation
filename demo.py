...
parser.add_argument('--distance', type=str, default='Chi2',choices=['Chi2', 'L2'],
                    help='the statistical distance')
...
record_file = os.path.join(record_dir, 'JWO_{}_{}_to_{}.txt'.format(args.net, args.source, args.target))
